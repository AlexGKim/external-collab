...
#    sponsor = models.ForeignKey(Sponsor, on_delete=models.CASCADE)      # for migration
    collaborators =  models.ManyToManyField('Person', related_name='proposals')
 #   collaborators =  models.ManyToManyField('SponsoredUser', related_name='proposals')    # for migration
